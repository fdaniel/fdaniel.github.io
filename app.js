...
const i18n = {
  en: {
    ...
    'about.text1': 'Senior WordPress Engineer with extensive experience building and maintaining high-traffic websites for globally recognized brands.',
    'about.text2': 'Specialized in custom theme and plugin development, WooCommerce solutions, headless WordPress architectures, performance optimization, and scalable multisite networks.',
  ...
  pt: {
    ...
    'hero.title': 'Engenheiro WordPress Sénior',
    ...
    'about.text1': 'Engenheiro WordPress Sénior com vasta experiência na construção e manutenção de websites de alto tráfego para marcas reconhecidas globalmente.',
    'about.text2': 'Especializado em desenvolvimento de temas e plugins personalizados, soluções WooCommerce, arquiteturas headless WordPress, otimização de performance e redes multisite escaláveis.',
